...
default['icinga2']['apache_modules'] = value_for_platform(
  ...
  %w(debian) => { 'default' => %w(default mod_python mod_php5 mod_cgi mod_ssl mod_rewrite mpm_prefork) },
  %w(ubuntu) => { 'default' => %w(default mod_python mod_php5 mod_cgi mod_ssl mod_rewrite mpm_prefork),
                  '>= 16.04' => %w(default mod_php7 mod_cgi mod_ssl mod_rewrite mpm_prefork) },
